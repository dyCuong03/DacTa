...
{
    [Key] [MaxLength(250)] public required int ProductId { get; set; }
    [MaxLength(250)] public required int ProductTypeId { get; set; }
    [MaxLength(250)] public required int BrandId { get; set; }
